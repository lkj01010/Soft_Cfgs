...
kmi = km.keymap_items.new('view2d.zoom', 'LEFTMOUSE', 'PRESS', alt=True)
...
kmi = km.keymap_items.new('image.view_zoom', 'LEFTMOUSE', 'PRESS', alt=True)
...
kmi = km.keymap_items.new('view3d.zoom', 'LEFTMOUSE', 'PRESS', alt=True)
