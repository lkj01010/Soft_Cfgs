...
kmi_props_setattr(kmi.properties, 'object_types', ['MESH'])
...
kmi = km.keymap_items.new('view3d.viewnumpad', 'F8', 'PRESS')
kmi_props_setattr(kmi.properties, 'type', 'TOP')
kmi_props_setattr(kmi.properties, 'align_active', True)
...
kmi = km.keymap_items.new('view2d.zoom', 'LEFTMOUSE', 'PRESS', ctrl=True, oskey=True)
