...
kmi = km.keymap_items.new('wm.search_menu', 'F', 'PRESS', oskey=True)
...
kmi = km.keymap_items.new('export_scene.fbx', 'E', 'PRESS', shift=True, oskey=True)
kmi_props_setattr(kmi.properties, 'use_selection', True)
kmi_props_setattr(kmi.properties, 'bake_space_transform', False)
kmi_props_setattr(kmi.properties, 'add_leaf_bones', False)
kmi_props_setattr(kmi.properties, 'bake_anim', False)
kmi_props_setattr(kmi.properties, 'bake_anim_use_all_bones', False)
kmi_props_setattr(kmi.properties, 'bake_anim_use_nla_strips', False)
kmi_props_setattr(kmi.properties, 'bake_anim_use_all_actions', False)
kmi_props_setattr(kmi.properties, 'bake_anim_force_startend_keying', False)
kmi_props_setattr(kmi.properties, 'use_anim', False)
kmi_props_setattr(kmi.properties, 'use_anim_action_all', False)
kmi_props_setattr(kmi.properties, 'use_default_take', False)
kmi_props_setattr(kmi.properties, 'use_batch_own_dir', False)
kmi_props_setattr(kmi.properties, 'use_metadata', False)
...
kmi = km.keymap_items.new('screen.region_quadview', 'F4', 'PRESS', oskey=True)
...
kmi = km.keymap_items.new('view2d.zoom', 'LEFTMOUSE', 'PRESS', alt=True, oskey=True)
...
kmi_props_setattr(kmi.properties, 'next', False)
kmi = km.keymap_items.new('screen.animation_play', 'E', 'PRESS', alt=True)
...
kmi = km.keymap_items.new('uv.export_layout', 'U', 'PRESS')
kmi_props_setattr(kmi.properties, 'modified', True)
...
kmi = km.keymap_items.new('image.view_all', 'R', 'PRESS', oskey=True)
kmi_props_setattr(kmi.properties, 'fit_view', True)
kmi = km.keymap_items.new('image.view_selected', 'NUMPAD_PERIOD', 'PRESS')
kmi = km.keymap_items.new('image.view_pan', 'LEFTMOUSE', 'PRESS', oskey=True)
...
kmi = km.keymap_items.new('image.view_zoom', 'LEFTMOUSE', 'PRESS', alt=True, oskey=True)
...
kmi = km.keymap_items.new('hops.mirror_mirror_y', 'Y', 'PRESS', shift=True, alt=True)
kmi = km.keymap_items.new('hops.mirror_mirror_x', 'X', 'PRESS', shift=True, alt=True)
kmi = km.keymap_items.new('btool.auto_subtract', 'MINUS', 'PRESS')
kmi = km.keymap_items.new('btool.auto_intersect', 'NUMPAD_ASTERIX', 'PRESS', shift=True, ctrl=True)
kmi = km.keymap_items.new('btool.auto_difference', 'NUMPAD_MINUS', 'PRESS', shift=True, ctrl=True)
kmi = km.keymap_items.new('btool.auto_union', 'EQUAL', 'PRESS')
kmi = km.keymap_items.new('btool.to_mesh', 'NUMPAD_ENTER', 'PRESS', shift=True, ctrl=True)
kmi = km.keymap_items.new('btool.brush_to_mesh', 'NUMPAD_ENTER', 'PRESS', ctrl=True)
kmi = km.keymap_items.new('btool.boolean_slice', 'NUMPAD_SLASH', 'PRESS', ctrl=True)
kmi = km.keymap_items.new('btool.boolean_inters', 'NUMPAD_ASTERIX', 'PRESS', ctrl=True)
...
kmi = km.keymap_items.new('object.modifier_add', 'D', 'PRESS', shift=True, ctrl=True)
...
kmi = km.keymap_items.new('mesh.select_mode', 'ONE', 'PRESS', oskey=True)
kmi_props_setattr(kmi.properties, 'use_extend', False)
kmi_props_setattr(kmi.properties, 'type', 'VERT')
kmi = km.keymap_items.new('mesh.select_mode', 'TWO', 'PRESS', oskey=True)
kmi_props_setattr(kmi.properties, 'type', 'EDGE')
kmi = km.keymap_items.new('mesh.select_mode', 'THREE', 'PRESS', oskey=True)
...
kmi_props_setattr(kmi.properties, 'mode', 'OBJECT')
kmi_props_setattr(kmi.properties, 'toggle', True)
kmi = km.keymap_items.new('object.origin_set', 'C', 'PRESS', shift=True, alt=True)
...
kmi = km.keymap_items.new('view3d.rotate', 'LEFTMOUSE', 'PRESS', shift=True, oskey=True)
kmi = km.keymap_items.new('view3d.move', 'LEFTMOUSE', 'PRESS', oskey=True)
kmi = km.keymap_items.new('view3d.zoom', 'LEFTMOUSE', 'PRESS', alt=True, oskey=True)
...
kmi = km.keymap_items.new('view3d.viewnumpad', 'F4', 'PRESS')
kmi_props_setattr(kmi.properties, 'type', 'CAMERA')
kmi = km.keymap_items.new('view3d.viewnumpad', 'F1', 'PRESS')
...
kmi = km.keymap_items.new('view3d.viewnumpad', 'F2', 'PRESS')
...
kmi = km.keymap_items.new('view3d.view_persportho', 'F5', 'PRESS')
kmi = km.keymap_items.new('view3d.view_orbit', 'NUMPAD_6', 'PRESS')
kmi_props_setattr(kmi.properties, 'type', 'ORBITRIGHT')
kmi = km.keymap_items.new('view3d.viewnumpad', 'F3', 'PRESS')
...
kmi = km.keymap_items.new('view3d.viewnumpad', 'F1', 'PRESS', oskey=True)
kmi_props_setattr(kmi.properties, 'type', 'BACK')
kmi = km.keymap_items.new('view3d.viewnumpad', 'F2', 'PRESS', oskey=True)
kmi_props_setattr(kmi.properties, 'type', 'LEFT')
kmi = km.keymap_items.new('view3d.viewnumpad', 'F3', 'PRESS', oskey=True)
...
kmi_props_setattr(kmi.properties, 'type', 'RIGHT')
kmi = km.keymap_items.new('view3d.viewnumpad', 'F6', 'PRESS')
kmi_props_setattr(kmi.properties, 'type', 'FRONT')
kmi_props_setattr(kmi.properties, 'align_active', True)
kmi = km.keymap_items.new('view3d.viewnumpad', 'F7', 'PRESS')
kmi_props_setattr(kmi.properties, 'type', 'RIGHT')
kmi_props_setattr(kmi.properties, 'align_active', True)
kmi = km.keymap_items.new('view3d.viewnumpad', 'F6', 'PRESS', oskey=True)
kmi_props_setattr(kmi.properties, 'type', 'BACK')
kmi_props_setattr(kmi.properties, 'align_active', True)
kmi = km.keymap_items.new('view3d.viewnumpad', 'F7', 'PRESS', oskey=True)
kmi_props_setattr(kmi.properties, 'type', 'LEFT')
kmi_props_setattr(kmi.properties, 'align_active', True)
kmi = km.keymap_items.new('view3d.localview', 'SPACE', 'PRESS')
...
kmi_props_setattr(kmi.properties, 'name', 'mops_main_menu')
kmi = km.keymap_items.new('view3d.viewnumpad', 'F8', 'PRESS', oskey=True)
kmi_props_setattr(kmi.properties, 'type', 'BOTTOM')
kmi_props_setattr(kmi.properties, 'align_active', True)
...
kmi = km.keymap_items.new('node.view_all', 'R', 'PRESS', oskey=True)
...
kmi_props_setattr(kmi.properties, 'value_1', 'DISABLED')
kmi_props_setattr(kmi.properties, 'value_2', 'ENABLED')
kmi = km.keymap_items.new('wm.context_toggle_enum', 'EVT_TWEAK_L', 'ANY', alt=True)
kmi_props_setattr(kmi.properties, 'data_path', 'tool_settings.proportional_edit')
kmi_props_setattr(kmi.properties, 'value_1', 'DISABLED')
kmi_props_setattr(kmi.properties, 'value_2', 'CONNECTED')
