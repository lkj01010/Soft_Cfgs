...
kmi = km.keymap_items.new('view3d.viewnumpad', 'F2', 'PRESS', shift=True)
kmi_props_setattr(kmi.properties, 'type', 'BACK')
kmi = km.keymap_items.new('view3d.viewnumpad', 'F1', 'PRESS', shift=True)
kmi_props_setattr(kmi.properties, 'type', 'LEFT')
kmi = km.keymap_items.new('view3d.viewnumpad', 'F3', 'PRESS', shift=True)
